...
@register_model
def pretrain_videomae_mvd_small_patch16_224(pretrained=False, **kwargs):
...
@register_model
def pretrain_videomae_mvd_base_patch16_224(pretrained=False, **kwargs):
    model = PretrainVisionTransformer(
        img_size=224,
        patch_size=16, 
        encoder_embed_dim=768, 
...
@register_model
def pretrain_videomae_mvd_large_patch16_224(pretrained=False, **kwargs):
    model = PretrainVisionTransformer(
        img_size=224,
        patch_size=16, 
