...
def show_metrics(anno_csv, preds_dir):
    ...
    unique_categories = set(df_preds["cat"].unique())
    ...
    df_group = df_preds[df_preds['clip'].isin(ego_clips)]
...
if __name__ == "__main__":
    DADA2K_anno = "/mnt/experiments/sorlova/datasets/LOTVS/DADA/DADA2000/DADA2K_my_split/frame_level_anno_val.csv"

    log_dir = "/VideoMAE_logs/train_logs/finetune/DoTA_orig/vm2-base_dota_lr5e4_b56x1_dsampl1val1_ld06_aam6n3/eval_DADA2K_ckpt_bestauroc"
    
    anno_csv = DADA2K_anno

    show_metrics(anno_csv=anno_csv, preds_dir=log_dir)
