...
import utils
import other_models.UMT.modeling_finetune
...
def main(args, ds_init):
    ...
    if args.finetune:
        ...
        if 'pos_embed' in checkpoint_model:
            ...
            if orig_size != new_size:
                ...
                print("No position embedding interpolation needed!")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats_, train_stats, plots, grad_norms = train_one_epoch(
            ...
            with_ttc=with_ttc, get_grad_norms=get_grad_norms
        )
        if get_grad_norms:
            # save grad norms
