...
def get_args():
    ...
    parser.add_argument('--data_set', default='Kinetics-400',
                        choices=['Kinetics-400', 'K700_aligned', 'SSV2', 'UCF101', 'HMDB51', 'DoTA', 'DADA2K', 'BDD100K', 'CAP-DATA', 'image_folder'],
...
def main(args):
    ...
    utils.auto_load_model(
        args=args, model=model, model_without_ddp=model_without_ddp, optimizer=optimizer, loss_scaler=loss_scaler, latest=args.auto_resume)
