...
@register_model
def mvd_vit_small_patch16_224(pretrained=False, **kwargs):
...
@register_model
def mvd_vit_base_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def mvd_vit_large_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def mvd_vit_huge_patch16_224(pretrained=False, **kwargs):
    model = VisionTransformer(
