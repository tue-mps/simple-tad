...
OUTPUT_DIR='/VideoMAE_logs/train_logs/finetune/DoTA/mvd-b-base_dota_lr5e4_b56x1_dsampl1val1_ld06_aam6n3'
# path to data set 
DATA_PATH='/datasets/DoTA'
# path to pretrained model
MODEL_PATH='/VideoMAE_logs/pretrained/MVD/mvd_b_from_b_ckpt_399.pth'
...
torchrun --nproc_per_node=1 \
    --master_port 12464 \
    other_models/MVD/run_frame_finetuning.py \
    --model mvd_vit_base_patch16_224 \
    --data_set DoTA \
    --loss crossentropy \
    --nb_classes 2 \
    --tubelet_size 2 \
